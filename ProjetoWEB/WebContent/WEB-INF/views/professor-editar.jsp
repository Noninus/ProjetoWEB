...
<div class="container">
  <h2>Editar Alunos</h2>
  <form onsubmit="return myFunction()" class="form-horizontal" action="editaProfessor" method="post">
    <div class="form-group">
      <label class="control-label col-sm-2" for="nome">Nome:</label>
      <div class="col-sm-10">
        <input value ="${tf.nome}" type="text" class="form-control" id="nome" placeholder="Digite seu Nome" name="nome">
